              ...
              <div class="header-left d-flex align-items-center"  >
                 INGRESE SKU
                  ...
                  <form method="post" action="${pageContext.request.contextPath}/proveedorServlet" id="f_listar" name="f_listar">
                    ...
                    <input type="hidden" name="accionModificar" id="accionModificar" value="modificarPersona"> 
                    ...
                    <table class="table">
                      ...
                      <tbody>
                         <c:forEach var="listaCli" items="${listaCli}">
                             <tr>
                                 <td scope="row">
                                     <a href="clienteServlet?rut=${listaCli.getRut()}&accion=listaEditar">
                                         <img src="dist/img/edit.png" alt="Modificar" style="width: 30px; height: 30px"/>
                                     </a>
                                 </td>
