            ...
            $(document).ready(function () {
             ...
             $(document).ready(function () {
                $("img[name=btn_calculadora]").click(function () {
                    var url = '${pageContext.request.contextPath}/Otros/calculadora.jsp';
                    ...
                    <div class="title-wrapper pt-30">
                        ...
                        <div class="icon-card mb-30">
                            <div class="imagenes-container ">
                              ...
                              <div class="imagen">
                                  <img src="${pageContext.request.contextPath}/assets/iconosoposibles/buscarSinFondo.png" alt="Guardado"  id="btn_guardar" name="btn_guardar"/>
                                          </div>
                              <div class="imagen">
                              ...
                              <div class="imagen">
                                  <img src="${pageContext.request.contextPath}/assets/iconosoposibles/modificarSinFondo.png" alt="Devolucion" id="btn_dev" name="btn_dev"  />
                              </div>
                              <div class="imagen">
                              ...
                              <div class="imagen">
                                  <img src="${pageContext.request.contextPath}/assets/iconosoposibles/boletasSinFondo.png" alt="Mayoreo" id="btn_mayoreo" name="btn_mayoreo" />
                              </div>
                              <div class="imagen">
                                <img src="${pageContext.request.contextPath}/assets/iconosoposibles/direccionesSinFondo.png" alt="Cierre" id="btn_cierre" name="btn_cierre"  />
                              </div>
                              <div class="imagen">
                                  <img src="${pageContext.request.contextPath}/iconosoposibles/calculadoraSinFondo.png" alt="Calculadora" id="btn_calculadora" name="btn_calculadora"/>
                                  </div>
                                  </div>
                          </div>
                    </div>
