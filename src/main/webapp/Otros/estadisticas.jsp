        ...
        <main class="main-wrapper">
            ...
            <section class="table-components">
                <div class="container-fluid">
                    ...
                    <!-- ========== title-wrapper end ========== -->
                     <script>
                        // Función para cargar los resultados al cargar la página
                        function cargarResultados() {
                            ...
                            xhr.open("GET", "${pageContext.request.contextPath}/productosVendidos", true);
                            xhr.send();
                        }
                    ...
                    <div class="tables-wrapper">
                        <h1>Productos más vendidos del día</h1>
                        <table>
                            <tr>
                                <th>Producto</th>
                                <th>Cantidad</th>
                            </tr>
                            <c:forEach var="row" items="${resultadosDia}">
                                <tr>
                                    <td>${row.producto}</td>
                                    <td>${row.cantidad}</td>
                                </tr>
                        ...
                        <h1>Productos más vendidos de la semana</h1>
                        <table>
                            <tr>
                                <th>Producto</th>
                                <th>Cantidad</th>
                            </tr>
                            <c:forEach var="row" items="${resultadosSemana}">
                                <tr>
                                    <td>${row.producto}</td>
                                    <td>${row.cantidad}</td>
                                </tr>
                        ...
                        <table>
                            ...
                            <c:forEach var="row" items="${resultadosMes}">
                                <tr>
                                    <td>${row.producto}</td>
                                    <td>${row.cantidad}</td>
                                </tr>
