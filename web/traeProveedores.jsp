                    ...
                    <div class="title-wrapper pt-30">
                        ...
                        <div class="icon-card mb-30">
                            <div class="imagenes-container ">
                              <div class="imagen">
                                  <img src="iconosoposibles/agregarSinFondo.png" alt="Post"  id="btn_accion" name="btn_accion"/>
                              </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/buscarSinFondo.png" alt="Guardado"  id="btn_guardar" name="btn_guardar"/>
                                          </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/eliminarSinFondo.png" alt="Cambio" id="btn_cambio" name="btn_cambio" />
                              </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/modificarSinFondo.png" alt="Devolucion" id="btn_dev" name="btn_dev"  />
                              </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/estadisticaSinFondo.png" alt="Boleta" id="btn_boleta" name="btn_boleta" />
                              </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/boletasSinFondo.png" alt="Mayoreo" id="btn_mayoreo" name="btn_mayoreo" />
                              </div>
                              <div class="imagen">
                                <img src="iconosoposibles/direccionesSinFondo.png" alt="Cierre" id="btn_cierre" name="btn_cierre"  />
                              </div>
                              <div class="imagen">
                                  <img src="iconosoposibles/calculadoraSinFondo.png" alt="Calculadora" id="btn_calculadora" name="btn_calculadora"/>
                                  </div>
                                  </div>
                          </div>
                    </div>
