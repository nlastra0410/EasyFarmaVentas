                    ...
                    <table class="table">
                      ...
                      <tbody>
                         <c:forEach var="listaCli" items="${listaCli}">
                             <tr>
                                 <td scope="row">
                                     <a href="${pageContext.request.contextPath}/clienteServlet?rut=${listaCli.getRut()}-${listaCli.getDv()}&accion=eliminar">
                                         <img src="${pageContext.request.contextPath}/assets/dist/img/borrar.png" alt="Modificar" style="width: 30px; height: 30px"/>
                                     </a>
                                 </td>
