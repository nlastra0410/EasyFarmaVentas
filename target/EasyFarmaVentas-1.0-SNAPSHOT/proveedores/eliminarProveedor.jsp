            ...
            <div class="col-lg-5 col-md-5 col-6">
              <div class="header-left d-flex align-items-center"  >
                 INGRESE SKU
                  ...
                  <form method="post" action="${pageContext.request.contextPath}/proveedorServlet" id="f_listar" name="f_listar">
                      <input id="codProd" name="codProd" type="text" placeholder="Search..."  />
                    <button><i class="lni lni-search-alt"></i></button>
                    <input type="hidden" name="accion" id="accion" value="buscar"> 
                    <input type="hidden" name="accionEliminar" id="accion" value="eliminarPersona"> 
                  </form>
                </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                         <c:forEach var="listaCli" items="${listaCli}">
                             <tr>
                                 <td scope="row">
                                     <a href="clienteServlet?rut=${listaCli.getRut()}-${listaCli.getDv()}&accion=eliminar">
                                         <img src="dist/img/borrar.png" alt="Modificar" style="width: 30px; height: 30px"/>
                                     </a>
                                 </td>
