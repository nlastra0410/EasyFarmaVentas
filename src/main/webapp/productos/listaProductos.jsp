                    ...
                    <table class="table">
                      ...
                      <tbody>
                         ...
                         <c:forEach var="listaProd" items="${listaProd}">
                             <tr>
                                <td scope="row"><a href="productoServlet?SKU=${listaProd.getSKU()}&accion=editar&accionEdit=accionEdit"><img src="${pageContext.request.contextPath}/assets/dist/img/edit.png" alt="Modificar" style="width: 30px; height: 30px"/></a></td>
                                ...
                                <td scope="row">${listaProd.getPrincipioactivo()}</td>
