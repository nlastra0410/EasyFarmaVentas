                    ...
                    <table class="table">
                      ...
                      <tbody>
                         <c:forEach var="listaProd" items="${listaProd}">
                                        <tr>
                                            <td scope="row"><a href="productoServlet?SKU=${listaProd.getSKU()}&accion=eliminar&accionEdit=accionEliminar">
                                                    <img src="${pageContext.request.contextPath}/assets/dist/img/borrar.png" alt="Modificar" style="width: 30px; height: 30px"/></a>
