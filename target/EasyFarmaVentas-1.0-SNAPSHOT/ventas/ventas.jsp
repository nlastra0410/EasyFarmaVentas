                    ...
                    <div class="title-wrapper pt-30">
                        ...
                        <div class="icon-card mb-30">
                            <div class="imagenes-container ">
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/Venta.gif" alt="Post"  id="btn_accion" name="btn_accion"/> Venta
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/guardado.png" alt="Guardado"  id="btn_guardar" name="btn_guardar"/> Guardado
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/Cambio.png" alt="Cambio" id="btn_cambio" name="btn_cambio" /> Cambio
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/devolucion.png" alt="Devolucion" id="btn_dev" name="btn_dev"  /> Devolución
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/boleta.png" alt="Boleta" id="btn_boleta" name="btn_boleta" /> Boleta
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/Mayoreo.png" alt="Mayoreo" id="btn_mayoreo" name="btn_mayoreo" /> Mayoreo
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/Corte.png" alt="Cierre" id="btn_cierre" name="btn_cierre"  /> Cierre
                                </div>
                                <div class="imagen">
                                    <img style=" width: 30px; height: 30px;" src="${pageContext.request.contextPath}/assets/iconosoposibles/calculadora.gif" alt="Calculadora" id="btn_calculadora" name="btn_calculadora"/> Calculadora
                                </div>
                            </div>
                            <!-- End Icon Cart -->
                        </div>
