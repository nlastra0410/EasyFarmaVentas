              ...
              <div class="card-style settings-card-2 mb-30">
                <div class="title mb-30">
                  ...
                  <form action="productoServlet" method="POST" >
                      ...
                      <input type="hidden" value="agregar2" name="accion">
                  <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        ...
                        <textarea id="Escribiraqui" name="Escribiraqui" placeholder="Escribir aquí" rows="6"></textarea>
                      </div>
                    </div>
                      <div class="title mb-30">
                        <h6>Stock</h6>
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        <label>Descripción</label>
                        <textarea id="EscribiraquiDesc" name="EscribiraquiDesc" placeholder="Escribir aquí" rows="6"></textarea>
                      </div>
                    </div>
                     <div class="title mb-30">
                        <h6>Precio</h6>
